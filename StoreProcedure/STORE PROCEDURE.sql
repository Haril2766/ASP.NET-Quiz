...
--EXEC PR_MST_User_Insert 'haril','xyz','harilparmar@gmail.com','9023960415'
...
--EXEC PR_MSt_User_Update '1','SAMIR','HARIL','hp','8780031119','1','0'
...
--EXEC PR_MST_Quiz_Insert 'ABC',10,3,'2020-10-10'
...
BEGIN
    ...
    WHERE [dbo].[MST_Quiz].[QuizID] = @QuizID
END
SELECT * FROM MST_User WHERE UserID = 1;
select * from MST_quiz
----------------------- Stored Procedures for MST_Question Table ------------------------------
--Stored Procedures for MST_Question Table Insert
-- EXEC PR_MST_Question_Insert 'wHAT IS THE COLOR OF dU LOGO',3,'rED','Option-B','Option-C','Option-D','Red',10,3
...
-- EXEC PR_MST_QuizWiseQuestions_Insert 1,10,3
...
-- EXEC PR_MST_QuizWiseQuestions_Delete 5
